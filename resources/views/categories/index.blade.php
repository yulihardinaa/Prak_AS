...
<div class="container">
    ...
    <div class="row">
        <div class="col">
        <h1 class="float-left">Table Categories</h1>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <td>
                ...
                <a href="/category/{{$category->id}}/delete}}" class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin?')">Delete</a>
            </td>
            </tr>
            @endforeach
        </tbody>
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Data Categories</h5>
